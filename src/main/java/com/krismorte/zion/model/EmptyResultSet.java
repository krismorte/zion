...
public class EmptyResultSet implements ResultSet {
    ...
    private final String DEFAULT_MESSAGE = "Your SQL command result on a empty ResultSet or No treatment output without error at the server";
    ...
    class EmptyResultSetMetaData implements ResultSetMetaData{
        ...
        public String getColumnLabel(int i) throws SQLException {
            return "EmptyOrNoTreatmentResultSet";
        }
