...
public class SQLDialect {
    ...
    public static String[] OPPERATIONS_SYNTAX_MSSQL = {"ALL", "AND", "ANY", "BETWEEN", "RIGHT", "IN", "INNER", "IS", "JOIN", "LIKE", "SOME", "LEFT", "CROSS", "NOT", "NULL", "UNPIVOT", "OR", "OUTER", "PIVOT", "EXISTS"};
    ...
    public static List<Biblioteca> getDialectMSSQL() {
        ...
        lst.add(new Biblioteca(SQLDialect.OPPERATIONS_SYNTAX_MSSQL, Color.gray));
